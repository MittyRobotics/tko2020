...
public class Ball6Auton extends SequentialCommandGroup {
    public Ball6Auton() {
        Path path1 = Path.Companion.quinticHermitePath(new Transform[]{
                ...
                new Transform(new Vector2D(inches(-50), inches(0)), new Rotation(degrees(180))),
        });
        ...
        Path path3 = Path.Companion.quinticHermitePath(new Transform[]{
                ...
                new Transform(new Vector2D(inches(40), inches(0)), new Rotation(degrees(0))),
        });
        ...
        PathTrajectory trajectory2 = new PathTrajectory(path2, inches(80), inches(50),
                0.5, 0, 0, 0, inches(80));
        PathTrajectory trajectory3 = new PathTrajectory(path3, inches(80), inches(50),
                0.5, 0, 0, 0, inches(80));
...
//                        new ExtendIntake(),
                        parallel(
                                ...
                                sequence(
                                        ...
                                        new UnloadConveyorCommand(true, 3),
                                        race(
