...
public class TestCommandGroup extends ParallelCommandGroup {
    public TestCommandGroup(){
        ...
        PurePursuitController follower = new PurePursuitController(
                ...
                new PathFollowerProperties.PurePursuitProperties(20*Conversions.IN_TO_M)
        );
        ...
        Path path = new Path(PathGenerator.generateQuinticHermiteSplinePath(new Transform[]{
                ...
                currentTransform.add(new Transform(100, 50,  Math.PI/4)).inToM()
        }));
        ...
        addCommands(
                ...
                sequence(
                        ...
                        new ManualSetConveyorCommand(1, .3)
                )
        );
    }
